...
var file_pkg_gopher_gopher_proto_rawDesc = []byte{
	...
	0x6c, 0x79, 0x22, 0x00, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x6f, 0x2d, 0x62, 0x79, 0x2d, 0x65, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x67,
	0x6f, 0x2d, 0x67, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pkg_gopher_gopher_proto_goTypes = []any{
...
func file_pkg_gopher_gopher_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_gopher_gopher_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_gopher_gopher_proto_msgTypes[1].Exporter = func(v any, i int) any {
